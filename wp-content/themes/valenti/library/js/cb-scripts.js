...
jQuery(document).ready(function($) { "use strict";
    ...
    /////////// Twitch Online Status @author John Lusky
    
    var twitchStatus = $(".twitch-status").attr("alt");
    
    console.log(twitchStatus);

    if ( $(window).width()>1019 ) {
    	if( twitchStatus == "offline" ) {
		console.log("Stream offline");
	} 
	else if ( twitchStatus == "online" ) {
		console.log("Stream online");
		$("#stream-showcase").delay(1500).slideDown(1000);
	}
    }
    else {
    	console.log("Window size too small for twitch box");
    } 
