...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      ...
      array(
        'id'          => 'cb_font_ext_lat',
        'label'       => 'Use Latin Extended Charset (Needed in some lanaguages)',
      ...
      array(
        'id'          => 'cb_font_cyr',
        'label'       => 'Use Cyrillic Extended Charset (Needed in some lanaguages)',
      ...
      array(
        'id'          => 'cb_bg_to',
        'label'       => 'Clickable Background Ad Takeover',
        'desc'        => '',
        'std'         => '',
        'type'        => 'select',
        'section'     => 'ot_advertising',
      ...
      array(
        'id'          => 'cb_bbp_sticky_background_color',
        'label'       => 'BuddyPress Sticky Posts Background Color',
        'desc'        => 'Set a color to be used on the backgrounds of sticky posts (Light tones are recommended).',
        'std'         => '',
        'type'        => 'colorpicker',
        'section'     => 'cb_buddypress',
