            ...
            <div class="cb-form-body">
                ...
                <?php if ( get_option('users_can_register') && !empty($lwa_data['registration']) ) : ?>
                    <div class="cb-register">
                           <span><?php esc_html_e('Not a member?','cubell') ?></span> <a href="http://multitoad.com/wp-login.php?action=register" class="cb-login-modal-closer"><?php esc_html_e('Register','cubell') ?></a>
                    </div>
                <?php endif; ?>
           </div> 
        </form>
